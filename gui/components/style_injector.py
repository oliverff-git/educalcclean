...
def inject_styles():
    ...
    /* Let Streamlit handle arrows naturally, just hide any fallback text */
    div[data-testid="stExpander"] summary span[title*="keyboard"] {
        display: none !important;
    }

    /* Optional: Clean up expander spacing without breaking arrows */
